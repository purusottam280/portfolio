...
const orbSkills = [
  { name: 'LangGraph', color: '#6366F1', size: 72, delay: 0 },
  { name: 'GPT-4', color: '#8B5CF6', size: 64, delay: 0.4 },
  { name: 'RAG', color: '#06B6D4', size: 68, delay: 0.8 },
  { name: 'Python', color: '#6366F1', size: 70, delay: 1.2 },
  { name: 'FastAPI', color: '#06B6D4', size: 60, delay: 0.2 },
  { name: 'CrewAI', color: '#8B5CF6', size: 62, delay: 0.6 },
  { name: 'Docker', color: '#06B6D4', size: 58, delay: 1.0 },
  { name: 'YOLOv8', color: '#F97316', size: 62, delay: 0.3 },
  { name: 'PyTorch', color: '#EF4444', size: 65, delay: 0.7 },
  { name: 'HuggingFace', color: '#FBBF24', size: 60, delay: 1.1 },
  { name: 'ChromaDB', color: '#6366F1', size: 58, delay: 0.5 },
  { name: 'Streamlit', color: '#06B6D4', size: 60, delay: 0.9 },
]
